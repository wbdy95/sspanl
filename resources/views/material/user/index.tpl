						...
						<div class="col-xx-12 col-xs-6 col-lg-3">
							...
							<div class="col-xx-12 col-xs-6 col-lg-3">
								<div class="card user-info">
									...
									<div class="user-info-bottom">
										<div class="nodeinfo node-flex">
											<span href="/user/shop"><i class="icon icon-md">attach_money</i>账户内可用于兑换套餐的金币</span>
										</div>
									</div>
								</div>
							</div>
												...
												<div class="tab-pane fade {if $ssr_prefer}active in{/if}" id="all_ssr">
                                                  ...
                                                  <div class="tab-pane fade" id="all_ssr_linux">
													...
													{if $display_ios_class>=0}
														...
														{/if}
													{/if}<!--在 Safari 中<a class="btn-dl" href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/xcxnig/ssr-download/master/potatso-lite.plist"><i class="material-icons">save_alt</i> 点击安装 Potatso Lite</a> -->
													<p><span class="icon icon-lg text-white">filter_1</span> 在非国区AppStore中搜索Shadowrocket（此软件需2.99刀）或者搜索potatso lite（免费）下载安装 </p>
														<p><span class="icon icon-lg text-white">filter_2</span> <!--打开 Potatso Lite，点击添加代理，点击右上角的 + 号，选择“订阅”，名字任意填写，开启自动更新，URL填写以下地址并保存即可-->
														使用shadowrocket,打开 Shadowrocket，点击右上角的 + 号，类型选择“Subscribe”，URL填写以下地址并点击右上角完成即可。或使用<a href="javascript:void(0);" class="btn-dl" style="margin-left: 5px;" data-onekeyfor="sub0"><i class="material-icons icon-sm">how_to_vote</i>小火箭一键{if !$mergeSub}普通{/if}端口订阅</a> {if !$mergeSub}<a href="javascript:void(0);" class="btn-dl" style="margin-left: 5px;" data-onekeyfor="sub1"><i class="material-icons icon-sm">how_to_vote</i>小火箭一键单端口订阅</a>{/if}</p>
														<div><span class="icon icon-lg text-white">flash_auto</span> {if !$mergeSub}普通节点{/if}订阅地址：</div>
...
.close:focus {
  ...
  <div class="modal1-content">
    <span class="close">×</span>
      <p>尊敬的用户∶</p>
      <p>由于一些你我都懂的原因，近期大批国外IP被封，导致多个节点无法使用。</p>
      <p>为此我们会不定期更新节点信息，避免大家无法使用。在使用过程中如遇到无法连接情况，请查看官网动态，及时更新节点。</p>
      <p>对使用上带来的不变，我们表示非常的抱歉。</p>
