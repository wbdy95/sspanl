								...
								<div class="card-inner">
									<div class="card-inner">
										...
										<!--	<button id="theme" type="button" class="form-control maxwidth-edit" data-toggle="dropdown" value="{$user->theme}">
											...
											<button id="theme" type="button" class="form-control maxwidth-edit" data-toggle="dropdown" value="material">
											...
											<ul class="dropdown-menu" aria-labelledby="mail">
												...
												{/foreach}-->
												{foreach $themes as $theme}
												<li><a href="#" class="dropdown-option" onclick="return false;" val="material" data="theme">material</a></li>
												{/foreach}
											</ul>
										</div>
								        </div>
