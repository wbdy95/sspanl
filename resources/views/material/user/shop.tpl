					...
					<div class="card">
						<div class="card-main">
							<div class="card-inner">
								<p>请先在充值界面中充值后，在此页面购买您需要的套餐。</p>
								<p>注：商品不可叠加，新购商品会覆盖旧商品的效果。</p>
								<p>如需升级套餐，请联系客服微信。</p>
                                <p>购买新套餐时，如果未关闭旧套餐自动续费，则旧套餐的自动续费依然生效。</p>
								<p>当前金币：<code>{$user->money}</code> 个</p>
							</div>
						</div>
					</div>
                  ...
                  <div class="card">
					  <div class="card-main">
								...
								<div class="shop-cube">
									...
									<div>
										<div class="cube-detail">
											{if {$shop->speedlimit()} == '0' }不限速{else}{$shop->speedlimit()}<span> Mbps</span>{/if}
										</div>
										<div class="cube-title">
											端口速率
										</div>
					...
					<div class="shop-gridarea">
						...
						<div class="shop-drop dropdown-area">
							...
							{/if}
								...
								<div class="card-tag tag-black">端口速率</div> <div class="card-tag tag-blue">不限速</div>
								{else}
