                        ...
                        <div class="card-main">
                            <div class="card-inner">
                                <div class="card-inner">
                                    ...
                                    <p>目前仅支持支付宝充值金币，充值完成后，请等待页面跳转，如充值失败，请截图付款页面，并联系管理员客服</p>
                                    <p>充值金币方法：</p>
									<p>下方输入充值金额（与您要购买的套餐金额一致）——点击支付宝按钮——跳转支付页面——扫码并输入页面提示相同金额——付款——等待页面跳转——充值成功</p>
                                    <p>建议不要过多充值，一经充值，不支持退换</p>
                                    {if $config["enable_admin_contact"] == 'true'}
                                        <p class="card-heading">如果没有到账请及时联系管理员客服：</p>
                                    ...
                                    {/if}
                                    <br/>
                                    <p><i class="icon icon-lg">attach_money</i>当前金币：<font color="#399AF2" size="5">{$user->money}</font> 个</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-inner">
                                <div class="card-inner">
                                    ...
                                    <div class="form-group form-group-label">
                                        <label class="floating-label" for="code">填入充值码</label>
