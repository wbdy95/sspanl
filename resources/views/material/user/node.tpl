						...
						<div class="node-card node-flex" cardindex="{$node@index}">
                            <div class="nodemain">
                                ...
                                <div class="nodemiddle node-flex">
                                    <div class="onlinemember node-flex"><i class="material-icons node-icon">flight_takeoff</i><span>{if $node['online_user'] == -1} 不限制{else} {$node['online_user']}{/if}</span></div>
                                   <!-- <div class="nodetype">{$node['status']}</div>-->
								   <div class="nodetype">在线人数</div>
                                </div>
                                <div class="nodeinfo node-flex">
                                  <!--  <div class="nodetraffic node-flex"><i class="material-icons node-icon">equalizer</i><span>{if $node['traffic_limit']>0}{$node['traffic_used']}/{$node['traffic_limit']}GB{else}{$node['traffic_used']}GB{/if}</span></div>
                                    ...
                                    <div class="nodeband node-flex"><i class="material-icons node-icon">flash_on</i><span>{if {$node['bandwidth']}==0}不限制{else}{$node['bandwidth']}{/if}</span></div>
                                </div>
                            </div>
